...
# keyword "_n" is IMSLU frontend plural function
# keyword "_s" is IMSLU frontend placeholder function
# keyword "_x" is IMSLU frontend context function
xgettext --files-from=locale/POTFILES.in --from-code=UTF-8 \
--output=locale/frontend.pot \
--copyright-holder="IMSLU Developers" --no-wrap --sort-output \
