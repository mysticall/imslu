...
CREATE TABLE `payments` (
  ...
  `date_payment1` datetime     NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `date_payment2` datetime     NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `expires`       datetime     NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `requests` (
  ...
  `assign`       datetime     NOT NULL DEFAULT CURRENT_TIMESTAMP,
